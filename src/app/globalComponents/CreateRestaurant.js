...
export default function CreateRestaurant() {
    ...
    const handleSubmit = (e) => {
        ...
        if (formData.postcode === '') {
            setErrorMessage('Please enter a postcode before submitting.');
            setSuccessMessage('');
            return;
        }
        ...
        if (formData.telephone === '') {
            setErrorMessage('Please enter a telephone number before submitting.');
            setSuccessMessage('');
            return;
        }
    ...
    return  (
      ...
      <h2 className="text-2xl font-bold mb-4 text-center">Create establishment page</h2>
